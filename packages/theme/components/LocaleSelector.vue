<template>
  <div class="container">
    <SfButton class="container__lang container__lang--selected" @click="isLangModalOpen = !isLangModalOpen">
        ...
        <SfListItem v-for="lang in availableLocales" :key="lang.code">
          <a :href="switchLocalePath(lang.code)">
            <SfCharacteristic class="language">
              ...
              <template #icon>
                <SfImage :src="addBasePath(`/icons/langs/${lang.code}.webp`)" width="20" alt="Flag"
...
export default {
  ...
  setup(props, context) {
    console.log('1111111111111111', context);
